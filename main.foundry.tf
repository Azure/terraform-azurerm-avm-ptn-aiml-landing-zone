module "foundry_ptn" {
  ...
  resource_names = {
    ...
    storage_account = var.ai_foundry_definition.ai_foundry_resources.storage_account.name
  }
  ...
  create_dependent_resources     = var.ai_foundry_definition.ai_foundry_resources.create_dependent_resources
  ...
  ai_search_resource_id       = var.ai_foundry_definition.ai_foundry_resources.ai_search.existing_resource_id
  cosmos_db_resource_id       = var.ai_foundry_definition.ai_foundry_resources.cosmos_db.existing_resource_id
  storage_account_resource_id = var.ai_foundry_definition.ai_foundry_resources.storage_account.existing_resource_id
