locals {
  ...
  foundry_ai_foundry = merge(
    var.ai_foundry_definition.ai_foundry, {
      ...
      private_dns_zone_resource_ids = var.private_dns_zones.azure_policy_pe_zone_linking_enabled ? null : [
        local.private_dns_zone_resource_ids.ai_foundry_openai_zone,
        local.private_dns_zone_resource_ids.ai_foundry_ai_services_zone,
        local.private_dns_zone_resource_ids.ai_foundry_cognitive_services_zone
      ]
  ...
  foundry_ai_search_definition = { for key, value in var.ai_foundry_definition.ai_search_definition : key => merge(
    var.ai_foundry_definition.ai_search_definition[key], {
      private_dns_zone_resource_id            = var.private_dns_zones.azure_policy_pe_zone_linking_enabled ? null : local.private_dns_zone_resource_ids.ai_search_zone
  ...
  foundry_cosmosdb_definition = { for key, value in var.ai_foundry_definition.cosmosdb_definition : key => merge(
    var.ai_foundry_definition.cosmosdb_definition[key], {
      private_dns_zone_resource_id            = var.private_dns_zones.azure_policy_pe_zone_linking_enabled ? null : local.private_dns_zone_resource_ids.cosmos_sql_zone
  ...
  foundry_key_vault_definition = { for key, value in var.ai_foundry_definition.key_vault_definition : key => merge(
    var.ai_foundry_definition.key_vault_definition[key], {
      private_dns_zone_resource_id            = var.private_dns_zones.azure_policy_pe_zone_linking_enabled ? null : local.private_dns_zone_resource_ids.key_vault_zone
  ...
  foundry_storage_account_definition = { for key, value in var.ai_foundry_definition.storage_account_definition : key => merge(
    var.ai_foundry_definition.storage_account_definition[key], {
      endpoints = {
        ...
        ek => {
          private_dns_zone_resource_id            = var.private_dns_zones.azure_policy_pe_zone_linking_enabled ? null : local.private_dns_zone_resource_ids["storage_${lower(ek)}_zone"]
